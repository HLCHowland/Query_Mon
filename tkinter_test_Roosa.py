...
#Catches unicode errors and skips line
        try:
            outF.write(line)
            outF.write("\n")
        except:
            print("Unicode error on saving")
            continue
    outF.close()
